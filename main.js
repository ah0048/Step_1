...
const translations = {
  ar: {
    ...
    'future': 'مستقبل',
    'your-child': 'طفلك',
    'hero-desc': 'مع Step 1، نقدم برامج تعليمية مبتكرة مخصصة للأطفال، وبرامج رعاية متكاملة لدعم نمو واحد تحت مظلة واحدة تجمع بين خدمات تأهيل وتدريب طفلك',
    'start-now': 'ابدأ رحلتك الآن',
    'explore': 'اكتشف المزيد',
    'about-us': 'من نحن؟',
    'about-desc-1': '1 Step هي منصة مبتكرة في مجال رعاية الأطفال، حيث نقدم استشارات طبية، تعليمية، وإجراءات طبية بسيطة، بالإضافة إلى دراسات وإحصاءات علاجية تجريبية تساعد على فهم احتياجات كل طفل بشكل أفضل. نحن نؤمن بأن كل طفل يستحق بداية قوية ومرتاحة في رحلته نحو مستقبل مشرق.',
    'about-desc-2': 'نقدم استشارات متخصصة في التغذية والصحة، والإجراءات الطبية البسيطة مثل الفحوصات المنزلية والمتابعة الدورية مع الفحص المنزلي والجسماني.',
    'families': 'عائلة مستفيدة',
    'specialists': 'مدرب متخصص',
    'rating': 'تقييم المستخدم',
    'featured': 'محتوى مميز',
    'popular': 'الأكثر طلباً',
    'featured-1-title': 'ماهى الخطوة الصحيحة؟',
    'featured-1-desc': 'أول واهم الأساسيات هي الوقوف على الذات',
    'featured-2-title': 'المهارات الأساسية للطفل',
    'featured-2-desc': 'أهم المهارات الأساسية التي يحتاجها طفلك في رحلة نموه',
    'featured-3-title': 'احجز استشارة لمدة شهر',
    'featured-3-desc': 'استفد من عروضنا الشهرية والمتابعة مع أفضل المتخصصين لدينا',
    ...
    'footer-desc': 'استثمر في مستقبل طفلك مع برامجنا المتخصصة والمبتكرة',
...
function addAdminLink() {
  ...
  if (footerLinks) {
    ...
    adminLink.innerHTML = '<a href="#" onclick="openAdminPanel(); return false;">لوحة التحكم</a>';
